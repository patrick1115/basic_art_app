...
public class CreateEllipse extends AbstractFactory implements IDrawShape {
    ...
    public CreateEllipse(Point startPoint, Point endPoint, IApplicationState appState, PaintCanvasBase paintCanvas) {
    ...
    public void drawShape() {
        ...
        if (getShapeShadingType() == ShapeShadingType.FILLED_IN) {
            ...
            graphics2d.fillOval((int)finalPoint.getX(), (int)finalPoint.getY(), width, height);
        }
        else if (getShapeShadingType() == ShapeShadingType.OUTLINE) {
            graphics2d.setColor(ColorMap.getColor(getPrimaryColor()));
            graphics2d.setStroke(stroke);
            graphics2d.drawOval((int)finalPoint.getX(), (int)finalPoint.getY(), width, height);
        }
    ...
    public void shapeOutline() {
        ...
        graphics2d.drawOval((int)finalPoint.getX()-2, (int)finalPoint.getY()-2, width+5, height+5);
        //
