...
public class CreateRectangle extends AbstractFactory implements IDrawShape {
    ...
    public CreateRectangle(Point startPoint, Point endPoint, IApplicationState appState, PaintCanvasBase paintCanvas) {
    ...
    public void drawShape() {
        ...
        if (getShapeShadingType() == ShapeShadingType.FILLED_IN) {
            ...
            graphics2d.fillRect((int)finalPoint.getX(), (int)finalPoint.getY(), width, height);
        }
        else if (getShapeShadingType() == ShapeShadingType.OUTLINE) {
            graphics2d.setColor(ColorMap.getColor(getPrimaryColor()));
            graphics2d.setStroke(stroke);
            graphics2d.drawRect((int)finalPoint.getX(), (int)finalPoint.getY(), width, height);   
        }
    ...
    public void shapeOutline() {
        ...
        graphics2d.drawRect((int)finalPoint.getX()-3, (int)finalPoint.getY()-3, width+5, height+5);
    }
